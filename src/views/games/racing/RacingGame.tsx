  ...
  return (
    <div className="pointer-events-auto absolute bottom-6 left-0 right-0 flex justify-between px-8 sm:hidden">
      <button
        ...
        className="flex h-16 w-16 items-center justify-center rounded-xl border border-white/20 bg-white/10 text-2xl text-white backdrop-blur-sm active:bg-white/20"
      >
        &larr;
      </button>
      <button
...
function GameOverOverlay() {
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="text-center">
        <h2 className="mb-2 text-4xl font-bold text-red-400">GAME OVER</h2>
