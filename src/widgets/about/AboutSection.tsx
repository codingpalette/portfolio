...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={container}
      className="relative bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 py-24"
    >
      {/* 배경 효과 */}
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div className="about-intro space-y-6 lg:col-span-2">
            ...
            <div className="space-y-4 text-center lg:text-left">
              <h3 className="text-2xl font-bold text-white">이성재</h3>
            ...
            <div className="flex justify-center gap-3 lg:justify-start">
              <a
                ...
                className="rounded-full border border-white/10 bg-white/5 p-2.5 text-gray-400 transition-all hover:border-white/20 hover:text-white"
              >
              ...
              {experiences.map((exp, i) => {
                ...
                return (
                  <div key={i} className="exp-card relative pl-8">
                    {/* 타임라인 점 */}
                    <div
                      className={`absolute top-2 left-0 h-[15px] w-[15px] rounded-full border-2 border-gray-900 ${colors.dot}`}
                    />
